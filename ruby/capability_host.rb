module Vagrant
  ...
  ### Copy paste long bad method to make grade bad
  def autodetect_capability_host2(hosts, *args)
    @cap_logger.info("Autodetecting host type for #{args.inspect}")
  ...
  def autodetect_capability_host3(hosts, *args)
    @cap_logger.info("Autodetecting host type for #{args.inspect}")
  ...
  def autodetect_capability_host4(hosts, *args)
    @cap_logger.info("Autodetecting host type for #{args.inspect}")
  ...
  def autodetect_capability_host5(hosts, *args)
    @cap_logger.info("Autodetecting host type for #{args.inspect}")
